 ...
 * @LastEditors: admin丶<baiwumm.com>
  ...
  return (
    <FloatButton.Group
      ...
      <FloatButton
        ...
        onClick={() => window.open('//github.com/baiwumm/react_nest_admin_web/issues')}
        tooltip={formatMessage({ id: `${INTERNATION.BASICLAYOUT}.ActionButtons.github-issues` })}
      />
      {/* 项目文档 */}
      <FloatButton
        onClick={() => window.open('//docs.baiwumm.com/personal-project/react_nest_admin_web')}
